...
Shader "StylizedForestLandscape/Landscape"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 appendResult33_g14 = (float4(1.0 , 1.0 , 1.0 , _Smoothness0));
				float3 temp_cast_0 = (_UvSize).xxx;
				float3 temp_output_3_0_g20 = ( WorldPosition / ( abs( temp_cast_0 ) * -1.0 ) );
				float3 temp_output_24_0_g20 = IN.ase_normal;
				float4 lerpResult21_g20 = lerp( tex2D( _PaintNoise, (temp_output_3_0_g20).xz ) , tex2D( _PaintNoise, (temp_output_3_0_g20).yz ) , abs( (temp_output_24_0_g20).x ));
				float4 tex2DNode17_g20 = tex2D( _PaintNoise, (temp_output_3_0_g20).xy );
				float4 lerpResult36_g20 = lerp( lerpResult21_g20 , tex2DNode17_g20 , abs( (temp_output_24_0_g20).z ));
				float4 temp_output_9_35_g19 = lerpResult36_g20;
				float4 lerpResult1_g19 = lerp( _GrassColor , ( _GrassPaintNoiseColor * temp_output_9_35_g19 ) , temp_output_9_35_g19);
				float4 temp_output_274_0_g14 = lerpResult1_g19;
				...
				float4 appendResult258_g14 = (float4(( (SplatControl26_g14).rrr * (_DiffuseRemapScale0).rgb ) , 1.0));
				float4 tintLayer0253_g14 = appendResult258_g14;
				float4 appendResult36_g14 = (float4(1.0 , 1.0 , 1.0 , _Smoothness1));
				float2 uv_Splat1 = IN.ase_texcoord8.xy * _Splat1_ST.xy + _Splat1_ST.zw;
				float4 tex2DNode3_g14 = tex2D( _Splat1, uv_Splat1 );
				float4 appendResult261_g14 = (float4(( (SplatControl26_g14).ggg * (_DiffuseRemapScale1).rgb ) , 1.0));
				float4 tintLayer1254_g14 = appendResult261_g14;
				float4 appendResult39_g14 = (float4(1.0 , 1.0 , 1.0 , _Smoothness2));
				float2 uv_Splat2 = IN.ase_texcoord8.xy * _Splat2_ST.xy + _Splat2_ST.zw;
				float4 tex2DNode6_g14 = tex2D( _Splat2, uv_Splat2 );
				float4 appendResult263_g14 = (float4(( (SplatControl26_g14).bbb * (_DiffuseRemapScale2).rgb ) , 1.0));
				float4 tintLayer2255_g14 = appendResult263_g14;
				float4 appendResult42_g14 = (float4(1.0 , 1.0 , 1.0 , _Smoothness3));
				float2 uv_Splat3 = IN.ase_texcoord8.xy * _Splat3_ST.xy + _Splat3_ST.zw;
				float4 tex2DNode7_g14 = tex2D( _Splat3, uv_Splat3 );
				float4 appendResult265_g14 = (float4(( (SplatControl26_g14).aaa * (_DiffuseRemapScale3).rgb ) , 1.0));
				float4 tintLayer3256_g14 = appendResult265_g14;
				float4 weightedBlendVar9_g14 = float4(1,1,1,1);
				float4 weightedBlend9_g14 = ( weightedBlendVar9_g14.x*( appendResult33_g14 * temp_output_274_0_g14 * tintLayer0253_g14 ) + weightedBlendVar9_g14.y*( appendResult36_g14 * tex2DNode3_g14 * tintLayer1254_g14 ) + weightedBlendVar9_g14.z*( appendResult39_g14 * tex2DNode6_g14 * tintLayer2255_g14 ) + weightedBlendVar9_g14.w*( appendResult42_g14 * tex2DNode7_g14 * tintLayer3256_g14 ) );
				float4 MixDiffuse28_g14 = weightedBlend9_g14;
				float4 temp_output_60_0_g14 = MixDiffuse28_g14;
				
				float3 temp_cast_7 = (0.0).xxx;
				

				float3 BaseColor = temp_output_60_0_g14.xyz;
...
Node;AmplifyShaderEditor.RangedFloatNode;11;-247,156;Inherit;False;Constant;_Float10;Float 10;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-261,223;Inherit;False;Property;_Smoothness;Smoothness;31;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;28;-562,-84;Inherit;False;MF_TerrianBaseShader;0;;14;37452fdfb732e1443b7e39720d05b708;2,102,0,85,0;8;274;COLOR;0,0,0,0;False;59;FLOAT4;0,0,0,0;False;60;FLOAT4;0,0,0,0;False;61;FLOAT3;0,0,0;False;57;FLOAT;0;False;58;FLOAT;0;False;201;FLOAT;0;False;62;FLOAT;0;False;7;FLOAT4;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;19;FLOAT3;17
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;StylizedForestLandscape/Landscape;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;20;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;5;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;terraincompatible=True;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;0;638374621947024402;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;2;638374621633820282;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-1083,86;Inherit;False;Property;_UvSize;UvSize;24;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;33;-898,59;Inherit;False;MF_Paint_Noise;25;;19;7e2ab49ced9a4b448ab1cdb326732eee;0;3;11;FLOAT;0;False;8;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
WireConnection;28;274;33;0
WireConnection;1;0;28;0
WireConnection;1;9;11;0
WireConnection;1;4;12;0
WireConnection;33;11;32;0
ASEEND*/
//CHKSM=13B92A6EB6E4D41A267634B262F9F1B0128CDE37